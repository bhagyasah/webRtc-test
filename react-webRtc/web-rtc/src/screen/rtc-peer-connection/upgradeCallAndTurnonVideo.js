...
class Index extends React.Component {
  ...
  render() {
    return(
      <div>
        <video id="localVideo" playsInline autoPlay muted style={{ width: 300, height: 200, background: 'black', margin: 20}}></video>
        <video id="remoteVideo" playsInline autoPlay style={{ width: 300, height: 200, background: 'black'}}></video>
        <div>
