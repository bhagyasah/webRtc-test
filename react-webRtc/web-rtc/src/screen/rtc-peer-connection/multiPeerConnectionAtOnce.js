...
function call() {
  ...
  if(audioTracks.length > 0) {
    console.log(`Using audio divice: ${audioTracks[0].label}`)
  }
...
class Index extends React.Component {
  ...
  render() {
    return(
      <div>
          <video id="video1" playsInline autoPlay muted style={{ width: 300, height: 200, margin: 30 }}></video>
          <video id="video2" playsInline autoPlay style={{ width: 300, height: 200, margin: 30 }}></video>
          <video id="video3" playsInline autoPlay style={{ width: 300, height: 200, margin: 30 }}></video>
