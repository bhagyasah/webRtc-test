...
class Index extends React.Component {
  ...
  render() {
    return(
      <div>
        <div id="videos">
          <video id="video1" playsInline autoPlay muted style={{ width: 300, height: 200, margin: 20 }}></video>
          <video id="video2" playsInline autoPlay style={{ width: 300, height: 200, margin: 20 }}></video>
        </div>
